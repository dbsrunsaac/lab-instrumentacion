...
\usepackage{xcolor}
\usepackage{tabularx}
\usepackage{multirow} % Permite fusionar las celdas para crear tablas más complejas
\usepackage{graphics} % for pdf, bitmapped graphics files
\usepackage{subfig}
\usepackage{subcaption} % Permite agregar figuras una al costado de otra
\usepackage{graphicx}
\usepackage{hyperref}
...
\begin{document}
	...
	\author{
		...
		\and
		\IEEEauthorblockN{Ing. Jose Luis Flores Vasquez}
